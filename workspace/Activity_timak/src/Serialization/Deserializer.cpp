...
Deserializer::Deserializer(const std::string& A_file) : _fileName(A_file)
{
...
bool Deserializer::run()
{
    ...
    for (auto i: elem)
    {
        if (myfile.is_open())
        {
            if (!(callDeserializationType(i.second, myfile) && i.first->serialization(myfile)))
            {
                DEF_ERROR("problem" );
                return false;
            }
...
bool Deserializer::callDeserializationType(team4::MetamodelElement* A_element, std::ofstream &A_stream)
{
    if (A_element->getType() == team4::ActivityNode::ELEMENT_TYPE)
    {
        return static_cast<team4::ActivityNode*>(A_element)->serialization(A_stream);
    }
    if (A_element->getType() == team4::Alt::ELEMENT_TYPE)
    {
        return static_cast<team4::Alt*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::DecisionNode::ELEMENT_TYPE)
    {
        return static_cast<team4::DecisionNode*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::InitialNode::ELEMENT_TYPE)
    {
        return static_cast<team4::InitialNode*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::ActivityFinalNode::ELEMENT_TYPE)
    {
        return static_cast<team4::ActivityFinalNode*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::Action::ELEMENT_TYPE)
    {
        return static_cast<team4::Action*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::StructuredActivityNode::ELEMENT_TYPE)
    {
        return static_cast<team4::StructuredActivityNode*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4:: MergeNode::ELEMENT_TYPE)
    {
        return static_cast<team4::MergeNode*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::ForkNode::ELEMENT_TYPE)
    {
        return static_cast<team4::ForkNode*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::JoinNode::ELEMENT_TYPE)
    {
        return static_cast<team4::JoinNode*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::FlowFinalNode::ELEMENT_TYPE)
    {
        return static_cast<team4::FlowFinalNode*>(A_element)->serialization(A_stream);
    }
    else if (A_element->getType() == team4::FinalNode::ELEMENT_TYPE)
    {
        return static_cast<team4::FinalNode*>(A_element)->serialization(A_stream);
    }
    else
    {
        return A_element->serialization(A_stream);
    }
    return false;
}
