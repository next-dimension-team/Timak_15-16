...
DecisionGraphics::DecisionGraphics(Ogre::ManualObject* manualObject, Ogre::SceneNode* sceneNode, DrawingAlgorithm* drawingAlgorihtm)
        : ElementGraphics(manualObject, sceneNode, drawingAlgorihtm)
{}

DecisionGraphics::~DecisionGraphics()
{}

Ogre::Vector3 DecisionGraphics::getConnectorBeginPoint(const std::string& A_name)
{
	DEFL;
    ...
    double thisSize = static_cast<DecisionAlgorithm*>(this->drawingAlgorihtm)->getFullSize();
...
Ogre::Vector3 DecisionGraphics::getConnectorEndPoint(const std::string& A_name)
{
